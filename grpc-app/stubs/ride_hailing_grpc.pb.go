...
type RideServiceClient interface {
	...
	RequestAppId(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RequestAppIdResponse, error)
...
func (c *rideServiceClient) RequestRide(ctx context.Context, in *RideRequest, opts ...grpc.CallOption) (*RideResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ridehailing.RideService/RequestRide", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rideServiceClient) RequestAppId(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RequestAppIdResponse, error) {
	out := new(RequestAppIdResponse)
	err := c.cc.Invoke(ctx, "/ridehailing.RideService/RequestAppId", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *rideServiceClient) StreamDriverLocation(ctx context.Context, in *DriverLocationRequest, opts ...grpc.CallOption) (RideService_StreamDriverLocationClient, error) {
	stream, err := c.cc.NewStream(ctx, &RideService_ServiceDesc.Streams[0], "/ridehailing.RideService/StreamDriverLocation", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *rideServiceClient) UpdateDriverLocation(ctx context.Context, opts ...grpc.CallOption) (RideService_UpdateDriverLocationClient, error) {
	stream, err := c.cc.NewStream(ctx, &RideService_ServiceDesc.Streams[1], "/ridehailing.RideService/UpdateDriverLocation", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *rideServiceClient) CompleteRide(ctx context.Context, in *RideCompletionRequest, opts ...grpc.CallOption) (*RideCompletionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ridehailing.RideService/CompleteRide", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RideServiceServer interface {
	...
	// just to showcase proxy logic in case of multiple servers
	RequestAppId(context.Context, *Empty) (*RequestAppIdResponse, error)
	// Stream driver's location to the user
...
func (UnimplementedRideServiceServer) RequestAppId(context.Context, *Empty) (*RequestAppIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestAppId not implemented")
}
...
func _RideService_RequestRide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ridehailing.RideService/RequestRide",
	}
...
func _RideService_RequestAppId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RideServiceServer).RequestAppId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ridehailing.RideService/RequestAppId",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RideServiceServer).RequestAppId(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RideService_CompleteRide_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ridehailing.RideService/CompleteRide",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var RideService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "RequestAppId",
			Handler:    _RideService_RequestAppId_Handler,
		},
		{
